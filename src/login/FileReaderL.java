...
public class FileReaderL{
    ...
    private FileReaderL(){
        ...
        drivers.add(new DriverL("mohammed","moha237"));
        drivers.add(new DriverL("ahmed","ahmed123"));

        passengers.add(new PassengerL("mahmoud","hiud2343"));
        passengers.add(new PassengerL("ibrahim","klfdsj786"));
    }
